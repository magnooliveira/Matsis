...
class Janela_Esc4(object):
	...
	def __init__(self):
		...
		self.arquivoglade = os.path.expanduser("~/Matsis/View/interface_do_sistema/Janela_Esc4.glade")
		...
		self.mainWindow.modify_bg(gtk.STATE_NORMAL, gtk.gdk.color_parse("#20B2AA"))
